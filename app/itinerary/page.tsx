...
const ItineraryPage = () => {
  ...
  const cards = [
    ...
    },
    {
      title: "Top Golf 🏌️",
      description:
        "We'll be finishing the night showing off our insane golf skills and it totally won't be a competition.",
      src: topGolf.src,
    },
    {
      title: "Pottery Painting 🎨",
      description:
        "We'll each put our own spin on a piece of pottery from Paint the Town while at home watching a movie of your choice. Snacks are 100% included.",
      src: potteryPic.src,
    },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center py-12 px-6 gap-12 bg-[#f0a6ca] font-inter">
      <h1 className="text-6xl font-bold animate-bounce font-playfair">
        Valentine Itinerary
      </h1>
